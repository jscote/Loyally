module.exports = {
    ...
    "attributes": {
        ...
        "name": {"relationship": "primitive", "dbType": "varchar(255)", "required": true, "unique": true},
        ...
        "location": {"relationship": "child", "cardinality": "single", "childIsInParentStructure": false, required: false,
            "attributes": {
                "address1": {"relationship": "primitive", "dbType": "varchar(255)", "required": true},
                "address2": {"relationship": "primitive", "dbType": "varchar(255)", "required": false},
                "city": {"relationship": "primitive", "dbType": "varchar(255)", "required": true},
                "state": {"relationship": "primitive", "dbType": "varchar(255)", "required": true},
                "zipCode": {"relationship": "primitive", "dbType": "varchar(255)", "required": true},
                "country": {"relationship": "primitive", "dbType": "varchar(255)", "required": true}
            }},
    ...
    "repositoryMethods": {
        "getEventByDateRange": {"cardinality": "multiple", "returnType": "DomainObject", "parameters": ["startDate", "endDate"], "dbProcedure": {"name": "getEventByDateRange", "parameters": ["startDate", "endDate"]}}
    },
    "businessMethods": {
        //TODO: basic method can be generated based on the same rule that determine which parameters are passed to the constructor.
        "setBasicInfo": {parameters: ["name", "startDate", "endDate"], "propertiesToSetFromParameter": [
            {paramName: "name", "propName": "name"},
            {paramName: "startDate", "propName": "startDate"},
            {paramName: "endDate", "propName": "endDate"}
        ]},
        ...
        "setLocation": {parameters: ["parameters"], "propertiesToSetFromParameter": [
            {paramName: "parameters.location", "propName": "location"}
        ]}
    }
